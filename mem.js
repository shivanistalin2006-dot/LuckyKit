...
function checkMatch(){
    ...
    if(isMatch){
        ...
        if(matches === 8){
            ...
            if (window.ArcadeCore) window.ArcadeCore.addXP(60);

            setTimeout(() => {
                overlayTitle.textContent = "🏆 You Won!";
                overlayMessage.textContent = `Time: ${seconds}s | Moves: ${moves}`;
...
// Remove automatic startGame() call, wait for overlay click